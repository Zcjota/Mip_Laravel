            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h1 style="text-align: center"><b>Listado Reporte Estado de Resultados</b></h1>
                        <br />
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input v-model="sFechaInicio" class="form-control" type="date" style="width:80px;"/>
                                    <input v-model="sFechaFin" class="form-control" type="date" style="width:80px;"/>
                                    <button class="btn btn-icon square btn-primary" v-on:click="listData(1, sFechaInicio, sFechaFin)">
                            ...
                            <div class="panel-body table-responsive">
                                ...
                                <div id="bodyListado">
                                    <table id="mainTableSG" class="tabla">
                                        ...
                                        <tbody>
                                            <tr v-for="data in aDataAux" :key="data.idKey" style="height:50px">
                                                <td>{{data.proceso}}</td>
                                                <td>{{data.mov_banco}}</td>
                                                <td>{{data.fecha}}</td>
...
<script>
    export default {
        ...
        methods: {
            ...
            listData(page, sFechaInicio, sFechaFin) {
                let me =this;
                me.aDataAux = [];
                var url = "/api/reporte/resultado?page="+page+"&fechaInicio="+sFechaInicio+"&fechaFin="+sFechaFin;
            ...
            listDataBankOriginCBX(){
                let me = this;
                axios.get('/api/reporte/combo/banco/origen').then(function (reponse){
            ...
            exportToExcel(){
                let me =this;
                location.href = "http://mip2024.isitecnologia.com/api/reporte/resultado/exportar?fechaInicio="+me.sFechaInicio+"&fechaFin="+me.sFechaFin;
                // location.href = "http://127.0.0.1:8000/api/reporte/resultado/exportar?fechaInicio="+me.sFechaInicio+"&fechaFin="+me.sFechaFin;
            },
            changePage(page){
                let me = this;
                me.pagination.current_page = page;
                me.listData(page, me.sFechaInicio, me.sFechaFin);
            },
            bugChecking(error) {
            var array=[];
