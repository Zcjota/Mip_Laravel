            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h1 style="text-align: center"><b>LISTADO DE SOLICITUD DE OTROS INGRESOS</b></h1>
                        <br />
                        <div class="row">
                            <div class="col-md-3">
                                <button type="button" class="btn btn-success square" v-on:click="openPDFtoPrint2('registrar')" title="Nuevo Registro">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <select v-model="tipoGasto" class="form-control square" style="width:70px;" v-on:change="validateDate">
                                    ...
                                    <input v-model="fechaInicio" class="form-control" type="date" style="width:80px;" v-on:click="listData(1, searchData, fechaInicio, fechaFin, tipoEstado,tipoGasto)"/>
                                    <input v-model="fechaFin" class="form-control" type="date" style="width:80px;" v-on:click="listData(1, searchData, fechaInicio, fechaFin, tipoEstado,tipoGasto)"/>
                                    <input type="text" v-model="searchData" class="form-control" placeholder="Buscar">
                                    <button class="btn btn-icon square btn-primary" v-on:click="listData(1, searchData, fechaInicio, fechaFin, tipoEstado,tipoGasto)">
                            ...
                            <div class="panel-body table-responsive">
                                ...
                                <div id="bodyListado">
                                    <table id="mainTableSG" class="tabla">
                                        ...
                                        <tbody>
                                            <tr v-for="data in aData" :key="data.cod_si" style="height:50px" v-on:click="changeRowColor('mainTableSG')">
                                                <td>
                                                    <button v-if="data.ACTIVO==1 && data.estado=='INI'" type="button" v-on:click="openWindow('actualizar', data)" class="btn btn-warning">
                                                ...
                                                <td>
                                                     <button v-if="data.ACTIVO==1 && (data.estado=='INI' || data.estado=='APR')" type="button" v-on:click="openPDFtoPrint(data)" class="btn btn-dark">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control input-format" v-model="model.fecha_si"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select-format" v-html="htmlListTipoPago" v-model="model.tipo_pago"></select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            <label class="lbl-format">Tipo Ingreso:</label>
                                            <select class="form-control select-format" v-html="htmlListTipoGasto" v-model="model.tipo_gasto"></select>
                                        </div>
                                    </div>
                                    
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            <label class="lbl-format">Banco De Destino:</label>
                                            <select v-model="model.cod_bc" class="form-control select-format" >
                                                <option disabled :value="-1">Seleccione..</option>
                                                <option v-for="data in aDataBanckAcount" :key="data.cod_bc" :value="data.cod_bc">{{data.sigla}}-{{data.nro_cuenta.slice(-5)}}-{{data.moneda}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div v-if="modalAction==2" class="col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <table class="table  table-hover-animation mb-0" style="width: 100%">
                                            <thead class="thead-dark">
                                                <tr style="background-color: #243648f0; color: white; height: 40px;">
                                                    <td class="table-thead-td" style="display:none;">ID</td>
                                                    <td class="table-thead-td">PROVEEDOR/PERSONAL</td>
                                                    <td class="table-thead-td">CTA. CONTABLE</td>
                                                    <td class="table-thead-td" style="width:200px;">DETALLE</td>
                                                    <td class="table-thead-td" align="right">BS</td>
                                                    <td class="table-thead-td" align="right">USD</td>
                                                    <td class="table-thead-td">BANCO</td>
                                                    <td style="width:10px;"></td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr v-if="model.detail.length === 0">
                                                    <td class="has-text-centered" colspan="7">No se han agregado productos</td>
                                                </tr>
                                                <tr v-else v-for="data in model.detail" :key="data.cod_proveedor">
                                                    <td class="table-tbody-td" style="display:none;">{{data.id}}</td>
                                                    <td class="table-tbody-td">{{data.nombre_proveedor}}</td>
                                                    <td class="table-tbody-td">{{data.nombre_cc}}</td>
                                                    <td class="table-tbody-td"  style="width:200px;">{{data.detalle.toUpperCase()}}</td>
                                                    <td class="table-tbody-td" align="right">{{data.importe_bs.toFixed(2)}} </td>
                                                    <td class="table-tbody-td" align="right">{{data.importe_usd.toFixed(2)}} </td>
                                                    <td class="table-tbody-td">{{data.nombre_bc}}</td>
                                                    <td>
                                                        <button v-on:click="removeDetail(data.id)" type="button" class="btn btn-icon  btn-danger">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td class="table-tfoot-td" colspan="3" align="right">TOTAL:</td>
                                                    <td class="table-tfoot-td" align="right">Bs {{totalBS.toFixed(2)}} </td>
                                                    <td class="table-tfoot-td" align="right">USD {{totalUSD.toFixed(2)}} </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" disabled="disabled" class="form-control" v-model="newDetail.nombreProveedor"/>
                                                            <button type="button" class="btn btn-icon square btn-primary" title="Buscar Responsable/Proveedor" v-on:click="openSearchProvider">
                                                                <i class="feather icon-search" aria-hidden="true">B</i>
                                                            </button>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" disabled="disabled" class="form-control" v-model="newDetail.nombreCuenta"/>
                                                            <button type="button" class="btn btn-icon square btn-primary" title="Buscar Cuenta Contable" v-on:click="openSearchAcount">
                                                                <i class="feather icon-search" aria-hidden="true">B</i>
                                                            </button>
                                                        </div>
                                                    </td>
                                                    <td  style="width:200px;">
                                                        <div class="control">
                                                            <textarea v-model="newDetail.detalle" class="form-control textarea-detalle-format" row="2" placeholder="DETALLE:"></textarea>
                                                        </div>
                                                    </td>
                                                    <td style="width:25px;">
                                                        <div class="control">
                                                            <input v-model="newDetail.importeBs" type="number" class="input-detalle-format" placeholder="Precio BS" />
                                                        </div>
                                                    </td>
                                                    <td style="width:25px;">
                                                        <div class="control">
                                                            <input v-model="newDetail.importeUSD" type="number" class="input-detalle-format" placeholder="Precio USD" />
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="control">
                                                            <select v-model="newDetail.codCuentaBanco" class="form-control select-format">
                                                                <option disabled :value="-1">Seleccione..</option>
                                                    ...
                                                    <td align="right">
                                                        <button v-bind:disabled="newDetail.codProveedor == -1" v-on:click="addDetail" class="btn btn-success colorVerde">
                                                            <i class="fa fa-plus" aria-hidden="true"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content model-content-format-2">
                            <div class="modal-header bg-success">
                                ...
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" v-on:click="closeSearchProvider">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="panel-body table-responsive">
                                    <div class="input-group">
    <input type="text" v-model="searchProvider" class="form-control" placeholder="Buscar Cuenta Contable" @input="listProvider(1, searchProvider)">
    <button type="submit" class="btn btn-primary" @click="listProvider(1, searchProvider)">
        <i class="fa fa-search"></i> Buscar
    </button>
</div>

                                    <table class="table table-striped table-hover-animation mb-0" style="width: 100%">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th style="width: 20px"></th>
                                                <th>TIPO</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr v-else v-for="data in aDataProvider" :key="data.id">
                                                <td>
                                                    <button v-on:click="selectSearchProvider(data)" type="button" class="btn btn-icon  btn-primary">
                                                ...
                                                <td>{{data.NRO_CUENTA}}-{{data.cuentaDescripcion}}</td>
                                                <td>{{data.sigla}}-{{data.bancoCuenta_nro_cuenta.slice(-5)}}-{{data.moneda}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item" v-if="paginationProvider.current_page > 1">
                                        <a class="page-link" href="#" @click.prevent="changePageProvider(paginationProvider.current_page - 1, searchProvider)">Ant</a>
                                    </li>
                                    <li class="page-item" v-for="page in pagesNumber" :key="page" :class="[page == isActived ? 'active' : '']">
                                        <a class="page-link" href="#" @click.prevent="changePageProvider(page, searchProvider)" >{{page}}</a>
                                    </li>
                                    <li class="page-item" v-if="paginationProvider.current_page < paginationProvider.last_page">
                                        <a class="page-link" href="#" @click.prevent="changePageProvider(paginationProvider.current_page + 1, searchProvider)">Sig</a>
                                    </li>
                                </ul>
                            </nav>
                            <div class="modal-footer">
                                <button type="button" v-on:click="closeSearchProvider" class="btn btn-danger">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content model-content-format-2">
                            <div class="modal-header bg-success">
                                ...
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close" v-on:click="closeSearchAcount">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="input-group">
                                    <input type="text" v-model="searchAcount" class="form-control" placeholder="Buscar Cuenta Contable" @input="listAcount(1, searchAcount)">
<button type="submit" class="btn btn-primary" @click="listAcount(1, searchAcount)">
    <i class="fa fa-search"></i> Buscar
</button>
                                </div>
                                <div class="panel-body table-responsive">
                                    <table class="table table-striped table-hover-animation mb-0" style="width: 100%">
                                        ...
                                        <tbody>
                                            <tr v-if="aDataAcount.length === 0">
                                                <td class="has-text-centered" colspan="5">No se han Encontrado Registros</td>
                                            </tr>
                                            <tr v-else v-for="data in aDataAcount" :key="data.COD_CUENTA">
                                                <td>
                                                    <button v-on:click="selectSearchAcount(data)" type="button" class="btn btn-icon  btn-primary">
                                                        <i class="fa fa-check" aria-hidden="true"></i>
                                                    </button>
                                                </td>
                            ...
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item" v-if="paginationAcount.current_page > 1">
                                        <a class="page-link" href="#" @click.prevent="changePageAcount(paginationAcount.current_page - 1, searchAcount)">Ant</a>
                                    </li>
                                    <li class="page-item" v-for="page in pagesNumber" :key="page" :class="[page == isActived ? 'active' : '']">
                                        <a class="page-link" href="#" @click.prevent="changePageAcount(page, searchAcount)" >{{page}}</a>
                                    </li>
                                    <li class="page-item" v-if="paginationAcount.current_page < paginationAcount.last_page">
                                        <a class="page-link" href="#" @click.prevent="changePageAcount(paginationAcount.current_page + 1, searchAcount)">Sig</a>
                                    </li>
                                </ul>
                            </nav>
                            <div class="modal-footer">
                                <button type="button" v-on:click="closeSearchAcount" class="btn btn-danger">
                                    <i class="fa fa-arrow-circle-left"></i> Cerrar
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-danger" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-warning" v-on:click="unregister(model.cod_si)">
    ...
    export default {
        ...
        methods: {
            ...
            cleanForm(){
                ...
                me.model.cod_si = 0;
                me.model.cod_tsi = 1;
                me.model.fecha_si = this.fecha('actual');
            ...
            openPDFtoPrint2(){
                //var pagina = "http://mip2024.isitecnologia.com/api/sgContadoPDF/"+data.cod_si;
                var pagina = "http://127.0.0.1:8000/api/siIngresoPDF/";
            ...
            openPDFtoPrint(data){
                var pagina = "http://mip2024.isitecnologia.com/api/siIngresoPDF/"+data.cod_si;
                // var pagina = "http://127.0.0.1:8000/api/siIngresoPDF/"+data.cod_si;
                var opciones = "toolbar=yes, location=no, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=yes, width=1000, height=800, top=0, left=0";
                window.open(pagina,"",opciones);
            },
            initialize() {
                ...
                me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado,me.tipoGasto);
            ...
            validateNewDetail(){
                ...
                if(me.newDetail.codProveedor == -1){
                    swal("Alerta de Mensaje", "Busque y Seleccione un Proveedor.", "warning");
                    return false;
                }
                if(me.newDetail.codCuentaContable == -1){
                    swal("Alerta de Mensaje", "Busque y Seleccione una Cuenta Contable.", "warning");
                    return false;
                }
                if (me.newDetail.detalle == ""){
                    ...
                    swal("Alerta de Mensaje", "El Detalle Debe Tener un Mínimo de 10 Caracteres.", "warning");
                    return false;
                }
                if ((me.newDetail.importeBs == "" || me.newDetail.importeBs <= 0)&&(me.newDetail.importeUSD == "" || me.newDetail.importeUSD <= 0)){
                ...
                if(me.model.tipo_pago == "TRANSFERENCIA"){
                    if(me.newDetail.codCuentaBanco == -1){
                        swal("Alerta de Mensaje", "Seleccione una Cuenta de Banco .", "warning");
                        return false;
                    }
                }
                return true;
            ...
            validateMainForm(){
                ...
                if(me.model.total_bs == 0 && me.model.total_usd == 0){
                    swal("Alerta de Mensaje", "Ingrese Mínimo un Detalle para la Solicitud.", "warning");
                    return false;
                }
                return true;
            },
            listData(page, buscar, fechaInicio, fechaFin, estado, tipoGasto) {
                let me =this;
                var tipoSolicitud = 1;
                var url = "/api/ZSolicitudIngreso/Buscar?page="+page+"&buscar="+buscar+"&fechaInicio="+fechaInicio+"&fechaFin="+fechaFin+"&estado="+estado+"&cod_tsi="+tipoSolicitud+"&tipo_gasto="+tipoGasto;
            ...
            listDataBankAcount(){
                ...
                axios.get('/api/ZBancoCuenta/ListarCbx').then(function (reponse){
                    ...
                    for (var i = 0; i < me.aDataBanckAcount.length; i++) {
                        me.htmlListBancoCuenta ="<option value='" + me.aDataBanckAcount[i].cod_bc +"'>" + me.aDataBanckAcount[i].sigla + "-" + me.aDataBanckAcount[i].nro_cuenta + "</option>";
                    }
                }).catch(function(error){
                    me.bugChecking(error);
                });
            ...
            listDataBankAcountDestiny(){
                let me = this;
                axios.get('/api/ZBancoCuentaDestiny/ListarCbx').then(function (reponse){
            ...
            changePage(page, buscar){
                ...
                me.listData(page, buscar, me.fechaInicio, me.fechaFin, me.tipoEstado,me.tipoGasto);
            },
            ...
            addDetail() {
                let me = this;
                if (me.newDetail.codProveedor != -1) {
                    if (me.model.detail.some(x => x.id === me.newDetail.id))
                        return;
                    if(!me.validateNewDetail())
                        return;
                    // let Acount = me.aDataAcount.find(x => x.COD_CUENTA === me.newDetail.codCuentaContable);
                    let Provider = me.aDataProvider.find(x => x.id === me.newDetail.codProveedor);
                    let BankAcount = me.aDataBanckAcountDestiny.find(x => x.cod_bc === me.newDetail.codCuentaBanco);
            ...
            saveRegister(){
                ...
                if(!me.validateMainForm())
                    return;
                axios.post('/api/ZSolicitudIngreso',{data:me.model,detalle:me.model.detail}).then(function (reponse){
                    if(reponse.data.status == "success"){
                        me.closeWindow();
                        me.cleanForm();
                        swal("Solicitud de Ingreso   ", "Registrado Correctamente.", "success");
                        me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado,me.tipoGasto);
                    } else {
                        swal("Solicitud de Ingreso   ", reponse.data.message, reponse.data.status);
                    }
                }).catch(function(error){
                    swal("Solicitud de Ingreso   ", error.response.data.message, error.response.data.status);
                });
            },
            getDataByID(id_sg){
                let me =this;
                var url = "/api/ZSolicitudIngreso/"+id_sg;
                axios.get(url).then(function (reponse){
                    var resp = reponse.data.result;
                    me.model.cod_si = resp.data.cod_si;
                    me.model.cod_tsi = resp.data.cod_tsi;
                    me.model.fecha_si = resp.data.fecha_si;
                    me.model.fecha_registro = resp.data.fecha_registro;
                    me.model.cod_usuario = resp.data.cod_usuario;
                    me.model.nro_si = resp.data.nro_si;
            ...
            updateRegister(){
                ...
                if(!me.validateMainForm())
                    return;
                axios.put('/api/ZSolicitudIngreso',{data:me.model, detalle:me.model.detail}).then(function (reponse){
                    if(reponse.data.status == "success"){
                        me.closeWindow();
                        me.cleanForm();
                        swal("Solicitud de Ingreso   ", "Registro Actualizado Correctamente.", "success");
                        me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado,me.tipoGasto);
                    } else {
                        swal("Solicitud de Ingreso   ", reponse.data.message, reponse.data.status);
                    }
            ...
            unregister(id_sg){
                let me = this;
                axios.put('/api/ZSolicitudIngreso/updateStatus',{
                    cod_si: id_sg,
                    estado: "ANU"
                    ...
                    if(reponse.data.status == "success"){
                        me.closeWindow();
                        me.cleanForm();
                        swal("Solicitud de Ingreso   ", "Registro Anulado Correctamente", "success");
                        me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado,me.tipoGasto);
                    } else {
                        swal("Solicitud de Ingreso   ", reponse.data.message, reponse.data.status);
                    }
            ...
            openWindow(action, data = []){
                ...
                switch(action) {
                    case "registrar": {
                        me.modal = 1;
                        me.modalTitle='Nueva Solicitud de Ingreso   ';
                        me.modalAction=1;
                        break;
                    };
                    case "actualizar": {
                        me.modal = 1;
                        me.modalTitle='Actualizar Registro Solicitud de Ingreso   ';
                        me.modalAction = 2;
                        me.getDataByID(data.cod_si);
                        break;
                    };
                    case "anular": {
                        me.model.cod_si = data.cod_si;
                        me.modalCancel = 1;
            ...
            selectSearchProvider(provider){
                ...
                me.newDetail.nombreCuentaBanco = provider.sigla+"-"+provider.bancoCuenta_nro_cuenta.slice(-5)+"-"+provider.moneda;
            ...
            selectSearchAcount(acount){
                ...
                me.newDetail.nombreCuenta = acount.fondoDescripcion+"-"+acount.NRO_CUENTA+"-"+acount.cueDescripcion;
