      ...
      <div class="card">
        <div class="card-header">
          <h1 style="text-align: center">
            <b>APROBACION DE SOLICITUD INGRESOS Y DEVOLUCIONES</b>
          </h1>
          <br />
          <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-9">
              <div class="input-group">
                ...
                >
                  ...
                  <option value="2">DEVOLUCIONES PERSONALES</option>
                </select>
                <select
                  v-model="tipoGasto"
                  class="form-control square"
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button
                ...
                v-on:click="ApproveRegister(model.cod_si)"
              >
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button
                type="button"
                class="btn btn-warning"
                v-on:click="RejectRegister(model.cod_si)"
              >
                <i class="fa fa-times"></i> Aceptar
              </button>
            </div>
...
export default {
  ...
  methods: {
    ...
    listData(page, buscar, fechaInicio, fechaFin, tipoSolicitud, tipoGasto) {
      let me = this;
      var url =
        "/api/ZSolicitudIngreso/aprobacion/Buscar?page=" +
        page +
        "&buscar=" +
        buscar +
        "&fechaInicio=" +
      ...
      axios
        ...
        .then(function (reponse) {
          if (reponse.data.status == "success") {
            ...
            me.cleanForm();
            swal(
              "Solicitud de Ingreso al Contado",
    ...
    ApproveRegister(id_sg) {
      let me = this;
      axios
        .put("/api/ZSolicitudIngreso/aprobacion/aprobar", {
          cod_si: id_sg,
          estado: "APR",
        })
        .then(function (reponse) {
          if (reponse.data.status == "success") {
            ...
            me.cleanForm();
            swal(
              "Aprobacion de Solicitud de Ingreso",
    ...
    RejectRegister(id_sg) {
      let me = this;
      axios
        .put("/api/ZSolicitudIngreso/aprobacion/rechazar", {
          cod_si: id_sg,
          estado: "REC",
        })
        .then(function (reponse) {
    ...
    openWindow(action, data = []) {
      ...
      switch (action) {
        case "registrar": {
          me.modal = 1;
          me.modalTitle = "Nueva Solicitud de Ingreso al Contado";
          me.modalAction = 1;
          break;
        }
        case "actualizar": {
          me.modal = 1;
          me.modalTitle = "Actualizar Registro Solicitud de Ingreso al Contado";
          me.modalAction = 2;
        ...
        case "visualizar": {
          me.modal = 1;
          me.modalTitle = "Informacion de la Solicitud de Ingreso";
          me.modalAction = 2;
          me.getDataByID(data.cod_si);
          break;
        }
