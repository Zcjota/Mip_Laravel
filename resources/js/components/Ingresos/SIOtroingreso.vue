            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h1 style="text-align: center"><b>LISTADO DE SOLICITUD DEVOLUCIONES PERSONAL</b></h1>
                        <br />
                        <div class="row">
                            <div class="col-md-3">
                                        ...
                                        <table class="table  table-hover-animation mb-0" style="width: 100%">
                                            <thead class="thead-dark">
                                                <tr style="background-color: #243648f0; color: white; height: 40px;">
                                                    ...
                                                    <td class="table-thead-td">PERSONAL</td>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content model-content-format-2">
                            <div class="modal-header bg-success">
                                <h3 class="modal-title titulo">Personal</h3>
    ...
    export default {
        ...
        methods: {
            ...
            listProvider(page, buscar) {
                let me =this;
                var url = '/api/Z_Persona/ListarCuentaCbxP?page='+page+"&buscar="+buscar;
                axios.get(url).then(function (reponse){
                    var resp = reponse.data.result;
