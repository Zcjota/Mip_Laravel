      ...
      <div class="card">
        ...
        <template v-if="listado">
          <div class="card-body">
            ...
            <div style="overflow-x:auto; height:600px" >
              ...
              <table id="tablaPrincipalReservaAdmin1" class="tabla" style="width:100%">
                <thead>
                  <!--#29363d -->
                ...
                <tbody>
                  <tr v-for="reserva in arrayReserva" :key="reserva.codReserva" @click="asignarIdOT(reserva.codOT,'tablaPrincipalReservaAdmin1')">
                    <td>
        ...
        <template v-else>
          ...
          <div class="card-body">
            <div class="form-group row">
              <div class="col-md-12">
                <h1 class="centro">REGISTRO DE RESERVAS 2</h1>
              </div>
            </div>
            <div class="row">
                <div class="col-md-6">
...
export default {
  ...
  //////////////////////////// verificar si el tecnico tiene trabajos en la mañana, para poder hacer reservas en la noche ejm 23:30 ///////////////////
    ...
    filtrarFechaTecnicoReplicacion_1(){
      let me = this;
      var url = '/tecnicos/listadoTecnicosFechaActualAdmin?fecha='+me.fechaReservaReplicacion;
      axios.get(url)
        .then(function(reponse) {  
          me.listaTecnicoReplicacion=reponse.data;
