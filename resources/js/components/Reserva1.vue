<template>
  <main class="main" >
          ...
          <div class="card-body">
             ...
             <div class="form-group row">
              <div class="col-md-6">
                  <div class="input-group">
                    <input type="text" v-model="buscar" @keyup="listarReservas1(1,fechaInicio,fechaFin,buscar)" class="form-control" placeholder="Buscar">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="input-group">            
            ...
            <div style="overflow-x:auto; height:600px" >
              ...
              <table id="tablaPrincipalReserva1" class="tabla" style="width:100%">
                ...
                <tbody>
                  <tr v-for="reserva in arrayReserva" :key="reserva.codReserva" @click="asignarIdOT(reserva.codOT,'tablaPrincipalReserva1')">
                    <td>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn btn-primary" title="Buscar Clientes" type="button" data-toggle="modal" data-target="#modalCliente" @click="buscarCliente()">
                          <i class="fa fa-search" aria-hidden="true"></i> Buscar
                        </button>
                        <button class="btn btn-success" title="Agregar Clientes" type="button" data-toggle="modal" data-target="#modalClienteRegistrar" @click="panelCliente()">
                ...
                <div class="col-md-3">
                    ...
                    <label for="company">
                      ...
                      <select class="form-control" v-model="equipoTecnico" v-html="arrayEquipoGenerado" @change="listarTecnicosEquipo()">
                      </select>
                      <!--
                      <select class="form-control" v-model="equipoTecnico" @change="listarTecnicosEquipo()">
                        <option v-for="equipo in arrayEquipo" :key="equipo.COD_EQUIPO" v-bind:value="equipo.COD_EQUIPO" v-text="equipo.DESCRIPCION">
                        </option>
                      </select>
                      -->
                      <span v-if="errorReserva.equipo" class="error rojo">{{errorReserva.equipo[0]}}</span>
                    </div>
                </div>
            </div>
            <br>
                ...
                <div class="tab-pane active show" id="home" role="tabpanel">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <select class="form-control" v-model="horaInicio" @change="obtHora()">
                            ...
                            <thead class="color">
                                <tr>
                                  <th class="encabezadoFijo centro" v-for="tecnico in listaTecnico" :key="tecnico.COD_PERSONAL" >
                                   <input type="checkbox"  :value="tecnico.COD_PERSONAL" v-model="selected">{{" "+obtNombreTipoPersonal(tecnico.TIPO_PERSONAL)}}<br> {{tecnico.NOMBRE +' '+tecnico.AP_PATERNO+' '+tecnico.AP_MATERNO}}
                                  </th>
                                </tr>
                            </thead>
                ...
                <div class="tab-pane" id="profile" role="tabpanel">
                    ...
                    <div class="row" style="height:480px;overflow-x:auto;">
                        <div class="col-md-12" style="padding: 0px;width:100px;">
                            ...
                            <thead class="color">
                                <tr>
                                  <th class="encabezadoFijo centro" v-for="tecnico in listaTecnicoReplicacion" :key="tecnico.COD_PERSONAL" >
                                   <input type="checkbox" :value="tecnico.COD_PERSONAL" v-model="selectedReplicacion">{{" "+obtNombreTipoPersonal(tecnico.TIPO_PERSONAL)}} <br> {{tecnico.NOMBRE +' '+tecnico.AP_PATERNO+' '+tecnico.AP_MATERNO}}
                                  </th>
                                </tr>
                            </thead>
    ...
    <!--Inicio del modal agregar/actualizar-->
                                  ...
                                  <div class="tab-pane active show" id="home" role="tabpanel">
                                        <div class="row">
                                          <div class="col-md-1"></div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group">
                                                  <input class="form-control" type="date" v-model="fechaReservaModificar" @change="listarTrabajadoresModificar(codReserva,fechaReservaModificar)"  placeholder="fecha" style="height:35px;">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                              <div class="form-group">
                                                ...
                                                <select class="form-control" v-model="horaInicioModificar">
                                                    <option v-for="horario in vectorHorario" :key="horario.value" v-bind:value="horario.value" v-text="horario.horario">
                                                    </option>
                                                </select>
                                              </div>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-control" id="timSe" name="timSe" v-model="tiempoServicioModificar">
                                                    <option v-for="tiempo in vectorTiempo" :key="tiempo.value" v-bind:value="tiempo.value" v-text="tiempo.text">
                                                    </option>
                                                </select>
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-control" v-model="tiempoTransporteModificar">
                                                    <option v-for="tiempo in vectorTiempo" :key="tiempo.value" v-bind:value="tiempo.value" v-text="tiempo.text">
                                                    </option>
                                                </select>
                                                </div>
                                       ...
                                       <div class="row" style="height:400px;overflow-x:auto;">
                                          <div class="col-md-12" style="padding: 0px;width:100px;">
                                              ...
                                              <thead class="color">
                                                  <tr>
                                                    <th class="encabezadoFijo centro" v-for="tecnico in listaTecnicoModificar" :key="tecnico.COD_PERSONAL" >
                                                    <input type="checkbox" :value="tecnico.COD_PERSONAL" v-model="selectedModificar">{{" "+obtNombreTipoPersonal(tecnico.TIPO_PERSONAL)}}<br> {{tecnico.NOMBRE +' '+tecnico.AP_PATERNO+' '+tecnico.AP_MATERNO}}
                                                    </th>
                                                  </tr>
                                              </thead>
        ...
        <!-- Inicio del modal Seleccionar Cliente -->
                                    ...
                                    <div style="overflow-x:auto;height:400px;">
                                      ...
                                      <table class="table table-responsive-sm table-bordered table-striped table-sm">
                                          <thead>
                                              <tr style="background-color:#243648f0;color:#ECF0F1;height:40px">
                                                  <th class="encabezadoFijo" style="width:40px;"></th>
                                                  <th class="encabezadoFijo" style="width:35%;">Nombre</th>
            ...
            <!--Inicio del modal Registrar Cliente-->
              <div class="modal fade" id="modalClienteRegistrar" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-success modal-lg ">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">REGISTRAR CLIENTE</h4>
                            <button type="button" class="close" aria-label="Close" @click="cerrarModalCliente()">
                              <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" data-dismiss="modal" aria-label="Close" @click="cerrarModalCliente()" class="btn btn-danger colorRojo">
                              <i class="fa fa-arrow-circle-left"></i> Cancelar
                            </button>
            ...
            <div class="modal fade" tabindex="-1" :class="{'mostrar':modalOT}" role="dialog" >
                <div class="modal-dialog modal-success modal-lg" role="document" >
                    <div class="modal-content" style="height: 580px;">
                                    ...
                                    <form action="" method="post" >
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                <input type="text" class="form-control" v-model="clienteOT">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="company">Telefono</label>
                                                <input type="number" class="form-control" v-model="telefonoOT">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="company">Contacto</label>
                                                <input type="text" class="form-control" v-model="contactoOT">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <label for="company">Razon Social</label>
                                                <input type="text" class="form-control" v-model="razonSocialOT">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="company">Nit</label>
                                                <input type="text" class="form-control" v-model="nitOT">
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    ...
                                                    <input type="number" step="0.25"   class="form-control" v-model="precioOT">
                                                ...
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    <div class="form-group" v-if="checked">
                                                      Con Factura <input type="checkbox" v-model="checked">
                                                    </div>
                                                    <div class="form-group" v-else>
                                                      Sin Factura <input type="checkbox" v-model="checked">
                                                    </div>
                                                  </div>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <label for="company">Direccion</label>
                                                <textarea name="textarea" class="form-control" rows="3" cols="12" v-model="direccionOT"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="tab-pane fade active show" id="plaga" role="tabpanel" aria-labelledby="plaga-tab">
                                        ...
                                        <table class="table table-bordered table-striped" >
                                              <thead>
                                                  <tr style="background-color:#243648f0;color:#ECF0F1;height:40px">
                                                      <th class="encabezadoFijo" style="width:40px;"><input type="checkbox" v-model="selectAllPlagaOT" @click="selectPlagaTodo()"></th>
                                                      <th class="encabezadoFijo">Plaga a Tratar</th>
                                                  </tr>
                                              </thead>
                                              <tbody >
                                      ...
                                      <div style="overflow-x:auto;height:290px;">
                                        <table class="table table-bordered table-striped">
                                            <thead>
                                                <tr style="background-color:#243648f0;color:#ECF0F1;height:40px">
                                                    <th class="encabezadoFijo" style="width:40px;"><input type="checkbox" v-model="selectAllLugarOT" @click="selectLugarTodo()"></th>
                                                    <th class="encabezadoFijo">Lugares a Tratar</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                      ...
                                      <div class="tab-pane fade" id="observaciones" role="tabpanel" aria-labelledby="observaciones-tab" style="background-color:#f0f3f5;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label for="company">Frecuencia Dias<span style="color:red">(*)</span></label>
                        ...
                        <div class="modal-footer">
                            <button type="button" @click="cerrarModalParametros()" class="btn btn-danger colorRojo"><i class="fa fa-arrow-circle-left"></i> Cancelar</button>
                ...
                <div class="modal-dialog modal-success" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" @click="cerrarModalParametros()">
                              <span aria-hidden="true">×</span>
                            </button>
                        </div>
                        <div class="modal-body" style="height:100px;">
                            ...
                            <div class="row" v-else>
                                <div class="col-md-6" align="right">
                                    <button type="button"  class="btn btn-primary colorAzul" @click="crearOT()"><i class="fa fa-plus"></i> Crear OT
                                </button>
                                </div>
                                <div class="col-md-6">
                                    <button type="button"  class="btn btn-primary colorAzul" @click="vincularOT()"><i class="fa fa-link"></i> Vincular OT
                                </button>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                              <button type="button" @click="cerrarModalParametros()" class="btn btn-danger colorRojo"><i class="fa fa-arrow-circle-left"></i> Cerrar
                              </button>
                        </div>
                    </div>
                </div>
    ...
    <!--fin -->
      ...
      <!-- Inicio del modal Seleccionar Cliente -->
            <div class="modal fade" :class="{'mostrar':mostrarModalOT}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-success modal-lg" role="document" style="max-width: 65%">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" v-model="buscarOT" @keyup="buscarOTFltro(1,buscarOT)" class="form-control" placeholder="Buscar OT">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row" >
                                    ...
                                    <div style="overflow-x:auto;height:450px">
                                      ...
                                      <table class="table table-bordered table-striped table-hover table-sm">
                                          <thead>
                                              <tr style="background-color:#243648f0;color:#ECF0F1;height:40px">
                                                  <th class="encabezadoFijo" style="width:40px;"></th>
                                                  <th class="encabezadoFijo" style="width:120px;">Permiso Modificar</th>
                                                  <th class="encabezadoFijo">Nro</th>
                                                  <th class="encabezadoFijo">Cliente</th>
                                                  <th class="encabezadoFijo" style="width:110px;">Fecha</th>
                                          ...
                                          <tbody>
                                              <tr v-for="ot in arrayOt" :key="ot.COD_ORDEN_TRABAJO" >
                                                  <td>
                                                      <button type="button" class="btn btn-primary colorAzul" @click="seleccionarOT(ot.COD_ORDEN_TRABAJO)"><i class="fa fa-plus"></i>
                                                      </button>
                                                  </td>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger colorRojo" data-dismiss="modal" @click="cerrarModalParametros()">
                              <i class="fa fa-arrow-circle-left"></i>
                              Cerrar
                            </button>
                        </div>
...
export default {
  data() {
    ...
    return {
      ...
      vectorHorario: [
        { horario: '00:00', value:'00:00:00'},//1
        { horario: '00:30', value:'00:30:00'},//2
        { horario: '01:00', value:'01:00:00'},//3
        { horario: '01:30', value:'01:30:00'},//4
        { horario: '02:00', value:'02:00:00'},//5
        { horario: '02:30', value:'02:30:00'},//6
        { horario: '03:00', value:'03:00:00'},//7
        { horario: '03:30', value:'03:30:00'},//8
        { horario: '04:00', value:'04:00:00'},//9
        { horario: '04:30', value:'04:30:00'},//10
        { horario: '05:00', value:'05:00:00'},//11
        { horario: '05:30', value:'05:30:00'},//12
        { horario: '06:00', value:'06:00:00'},//13
        { horario: '06:30', value:'06:30:00'},//14
        { horario: '07:00', value:'07:00:00'},//15
        { horario: '07:30', value:'07:30:00'},//16
        { horario: '08:00', value:'08:00:00'},//17
        { horario: '08:30', value:'08:30:00'},//18
        { horario: '09:00', value:'09:00:00'},//19
        { horario: '09:30', value:'09:30:00'},//20
        { horario: '10:00', value:'10:00:00'},//21
        { horario: '10:30', value:'10:30:00'},//22
        { horario: '11:00', value:'11:00:00'},//23
        { horario: '11:30', value:'11:30:00'},//24
        { horario: '12:00', value:'12:00:00'},//25
        { horario: '12:30', value:'12:30:00'},//26
        { horario: '13:00', value:'13:00:00'},//27
        { horario: '13:30', value:'13:30:00'},//28
        { horario: '14:00', value:'14:00:00'},//29
        { horario: '14:30', value:'14:30:00'},//30
        { horario: '15:00', value:'15:00:00'},//31
        { horario: '15:30', value:'15:30:00'},//32
        { horario: '16:00', value:'16:00:00'},//33
        { horario: '16:30', value:'16:30:00'},//34
        { horario: '17:00', value:'17:00:00'},//35
        { horario: '17:30', value:'17:30:00'},//36
        { horario: '18:00', value:'18:00:00'},//37
        { horario: '18:30', value:'18:30:00'},//38
        { horario: '19:00', value:'19:00:00'},//39
        { horario: '19:30', value:'19:30:00'},//40
        { horario: '20:00', value:'20:00:00'},//41
        { horario: '20:30', value:'20:30:00'},//42
        { horario: '21:00', value:'21:00:00'},//43
        { horario: '21:30', value:'21:30:00'},//44
        { horario: '22:00', value:'22:00:00'},//45
        { horario: '22:30', value:'22:30:00'},//46
        { horario: '23:00', value:'23:00:00'},//47
        { horario: '23:30', value:'23:30:00'},//48
      ],
      estadoReserva:0,
      datoReserva:[],
  ...
  methods: {
    ...
    registrarReserva() 
    {
      ...
      {     
          ...
          if(me.equipoTecnico!='888')
          {
            ...
            {
              var respReserva = me.validarTecnicosSeleccionados(me.selected);
              //var respReplicacion = me.validarTecnicosSeleccionados(me.selectedReplicacion);
              if(respReserva!="ok")
                swal("MENSAJE RESERVA", respReserva, "warning");
              else
              {
                  me.validarReserva(1,me.fechaReserva,me.horaInicio,me.tiempoTransporte,me.tiempoServicio,me.listadoDetalleReserva,me.selected,me.listaTecnico);
              }
          ...
          {
            //Operaciones, se registra las reservas sin tecnicos asociados
            me.validarReservasSinTecnicos(1,me.horaInicio,me.tiempoTransporte,me.tiempoServicio);
          }
    ...
    //valida los tenicos chofer y ayudante
    validarTecnicosSeleccionados(selected){
      let me = this;
      var resp="ok";
      var maxChofer=0;
      var maxAyudante=0;
      for(var v=0;v<selected.length;v++){
        for(var z=0;z<me.listaTecnico.length;z++){
          if(selected[v]==me.listaTecnico[z].COD_PERSONAL && me.listaTecnico[z].TIPO_PERSONAL==2){
            maxChofer++;
          }
          else{
            if(selected[v]==me.listaTecnico[z].COD_PERSONAL && me.listaTecnico[z].TIPO_PERSONAL==4){
            maxAyudante++;
          }
          }
      ...
      if(maxChofer>=2){
        resp="NO PUEDEN HABER 2 CHOFERES EN LA RESERVA";
      }
      else{
        var maxTec = maxChofer+maxAyudante;
        if(maxAyudante>=3)
        {
          resp="NO PUEDEN HABER MAS DE 2 TECNICOS EN LA RESERVA";
        }
        else{
          if(maxTec>2)
          resp="NO PUEDEN HABER MAS DE 2 TECNICOS EN LA RESERVA";
    ...
    //ConfirmacionGuardarReservaSinTecnicos
    ConfirmacionGuardarReservaSinTecnicos(horarioNocturno,cambiarFecha,contadorNocturno,contadorNocturnoV)
    {
        let me = this;
        if(me.fechaReservaReplicacion=="")
        {
          swal({
            title: 'Desea guardar la reserva sin Replicacion?',
            text: "Reserva sin Tecnicos asociados",
            type: 'warning',
            ...
            .then((result) => 
            {
              if (result.value) 
              {
                me.guardarSinReplicacionSinTecnicos(horarioNocturno,cambiarFecha,contadorNocturnoV);
              } 
              else
              {
                (result.dismiss === swal.DismissReason.cancel) 
                
                me.validarFechaRep=1;
                // $.unblockUI();
                //almacena los datos de la reserva, para guardar reserva y reaplicacion
                me.horarioNocturnoR=horarioNocturno;
                me.cambiarFechaR=cambiarFecha;
                me.contadorNocturnoVR=contadorNocturnoV.length;
        ...
        else
        {
          ...
          //Operaciones, se registra las reservas sin tecnicos asociados
          me.validarReservasSinTecnicos(2,me.horaInicioReplicacion,me.tiempoTransporte,me.tiempoServicioReplicacion);
    ...
    actualizarReserva(){
      ...
      {
        var respReserva = me.validarTecnicosSeleccionados(me.selectedModificar);
        if(respReserva!="ok")
            swal("MENSAJE RESERVA", respReserva, "warning");
        else
        {
        ...
        for (var t = 0; t < this.vectorHorario.length; t++) 
        {
          if (this.vectorHorario[t].horario == horaInicioCliente) 
          {
            for (var x = 0; x < sumaHorario-1; x++) 
            {
                ...
                {
                  //varCon++;
                  arrayHorarioClienteReservaIndividual.push({horario: this.vectorHorario[varCon].horario,nocturno:0});
                  //console.log("ok2  - "+this.vectorHorario[varCon].horario );
                  if(this.vectorHorario[varCon].horario=='00:00' || contadorNocturnoV.length>0)//&& contadorNocturno!=-1
                  {
            ...
            if(selected.includes(listaTecnico[r].COD_PERSONAL))
            {
              ...
              if(ok==1){
                noc=1;
                  ...
                  arrayValidacionesTecnicos.push({id:listaTecnico[r].COD_PERSONAL,nombre:nombre, mensaje:"No se puede asignar, trabajo hasta o mas de las 00:00 am."});
  ...
  //////////////////////////// verificar si el tecnico tiene trabajos en la mañana, para poder hacer reservas en la noche ejm 23:30 ///////////////////
       ...
       if(this.fechaReservaReplicacion=="")
        ...
        else
        {
          ...
          if (me.selectedReplicacion.length > 0)
          {
              ...
              swal("MENSAJE REPLICACION", respReplicacion, "warning");
    ...
    modificarReserva(){
      ...
      if(this.fechaReservaModificar!=this.fechaReservaModificarCambio || this.horaInicioModificar!=this.horaInicioModificarCambio)
      {
        ...
        axios.put('/reservas/modificarReserva',{
                      ...
                      {
                          me.actualizarOT(me.fechaReservaModificar,me.horaInicioModificar.substring(0, 5),me.codOTReprogramacion);
                      }
    ...
    actualizarOT(fecha,hora,codigo){
      ...
      //alert("almacen");
      var pagina = 'http://isi-app.online/1Servicios/web/mip/ajax/ot.php?op=actualizarOT&fecha='+fecha+"&hora="+hora+"&codigo="+codigo;
                          var opciones = "toolbar=yes, location=no, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=yes, width=10, height=10, top=0, left=0";
    ...
    guardarSinReplicacion(horarioNocturno,cambiarFecha,contadorNocturno,contadorNocturnoV)
    {
       ...
       // alert(horarioNocturno+" - "+contadorNocturnoV.length);
          let me = this;
            axios.post('/reservas/registrar',{
                    'cliente':this.cliente,
                    'tiempoTransporte':this.tiempoTransporte,
    ...
    listarReservas1(page,fechaInicio,fechaFin,buscar) 
    {
      if(fechaInicio!=''){
        if(fechaFin=='')
    ...
    modificar(reserva){
      let me =this;
      me.equipoTecnico='';
      if(me.codPersonal==reserva.codPersonal)
      {
      ...
      swal("Mensaje", "Esta reserva, ha sido registrada por otra persona", "warning");
    ...
    filtrarFechaTecnicoModificar(idReserva,fecha){
      let me = this;
      var url = '/tecnicos/listadoTecnicosFechaActual?fecha='+fecha;
      axios.get(url)
        .then(function(reponse) {  
    ...
    registrarCliente() 
    {
      ...
      .catch(function(error)
      {
        ...
        /*
          ...
          {
            swal("Mensaje ",me.mensajeError +" ", "error");
          }
          */
            ...
            .then((result) => 
            {
              if (result.value) 
              {
                  ...
                  axios.put('/reservas/vincularOT',{
                                ...
                                me.buscarOT='';
                                me.buscarOTFltro(1,'');
                                swal("Reserva Actualizada!", "Vinculado Correctamente", "success");
                            }).catch(function (error) {
                                me.controlError(error);
                            });
    ...
    buscarOTFltro(page,buscar) {
      let me = this;
      var url = '/reserva/listarOTSinAsignacion?page='+page+"&buscar="+buscar;
      axios .get(url)
        .then(function(reponse) {
          var resp =  reponse.data;
    ...
    crearOT(){
      ...
      if(this.datoReserva.codOT==null)
      {
        if(this.estadoReserva==1)
        {
            ...
            this.tituloModal="ORDEN DE OT | "+this.datoReserva.NOMBRE+' '+this.datoReserva.AP_CLIENTE+' '+this.datoReserva.AM_CLIENTE;
            this.clienteOT=this.datoReserva.NOMBRE+' '+this.datoReserva.AP_CLIENTE+' '+this.datoReserva.AM_CLIENTE;
    ...
    validarOT(){
      ...
      {
        me.clickOT=1;
          axios.post('/Reserva/registrarOT',{
          ...
          'dataLugar':this.selectLugarOT,
              ...
              var pagina = "http://solucionesintecruz.com.bo/MIP/PLAGAS/DSforms/DSimprimirOTAjax.php?codigo="+ reponse.data;
          ...
          {
            me.clickOT=0;
            me.errorOT = me.controlError(error);
          }); 
        }
    ...
    obtNombreTipoPersonal(codigo){
      ...
      */
      var nom="";
      switch(codigo){
        case 2 : nom = "TECNICO CHOFER";break;
        case 4 : nom = "TECNICO AYUDANTE";break;
      }
