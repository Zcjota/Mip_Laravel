        ...
        <template v-if="listado">
          ...
          <div class="card-body">
            ...
            <div style="overflow-x:auto; height:600px" >
              <table id="tablaPrincipalReserva" class="tabla" style="width:100%">
                <thead>
                  <!--#29363d -->
                ...
                <tbody>
                  <tr v-for="reserva in arrayReserva" :key="reserva.codReserva" @click="asignarIdOT(reserva.codOT,'tablaPrincipalReserva')">
                    <td>
                    ...
                    <td v-text="reserva.NOMB_PERSONAL+' '+reserva.APP_PERSONAL"></td>
              ...
              <div class="tab-content"  style="background-color:#f0f3f5">
                <div class="tab-pane active show" id="home" role="tabpanel">
                    ...
                    <div class="row" style="height:450px;overflow-x:auto;">
                        ...
                        <div class="right col-md-9" style="padding: 0px;width:110px;overflow-y: scroll;">
                            <table class="table table-responsive-sm table-bordered table-striped table-hover" border="1" style="width:100%">
                            <thead class="color">
                                <tr>
                                  <th class="encabezado" v-for="horario in vectorHorario" :key="horario.horario" v-text="horario.horario"></th>
                                </tr>
                            </thead>
                ...
                <div class="tab-pane" id="profile" role="tabpanel">
                    ...
                    <div class="row" style="height:450px;overflow-x:auto;">
                        <div class="col-md-3" style="padding: 0px;width:100px;">
                            ...
                            <tbody>
                                <tr v-for="tecnico in listaTecnicoReplicacion" :key="tecnico.COD_PERSONAL">
                                  <td>
                                      <label class="form-checkbox">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" @click="cerrarModalCliente()" class="btn btn-danger colorRojo">
                              <i class="fa fa-arrow-circle-left"></i> Cancela
                            </button>
      ...
      .catch(function(error)
      {
        ...
        /*
          if(error.response.status==422){
            me.errorReserva  = error.response.data.errors;
          }
          */
      });
    },
    ...
    listarDetalleReservaModificar(listaTecnico,idReserva,fecha) {
     ...
     // var idReserva=80;
      axios.get("/DetalleReservaModificar?page=1&idReserva="+idReserva+"&fecha="+fecha).then(function(reponse) {
          ...
          me.filaBodyReservaModificar = me.bodyFila(listaTecnico,me.listadoReservaModificar);
        })
        .catch(function(error) {
          me.controlError(error);
        });
