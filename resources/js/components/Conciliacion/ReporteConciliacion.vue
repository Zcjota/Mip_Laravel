      ...
      <div class="card">
        <div class="card-header">
          <h1 style="text-align: center">
            <b>REPORTE DE EGRESOS E INGRESOS</b>
          </h1>
          <br />
          <div class="row">
            <div class="col-md-6">
        ...
        <div class="card-body">
          <div style="overflow-x: auto">
            <div class="panel-body table-responsive">
              ...
              <div v-if="tipoMovimiento == '1'" id="bodyListado">
                <table id="mainTableSG" class="tabla">
                  ...
                  <tbody>
                    <!-- <tr v-for="data in aData" :key="data.cod_detalle || data.cod_detalle_ingreso" -->
                    <!-- <tr v-for="data in aData" :key="data.id_detalle_solicitud" -->
                    <tr
              ...
              <div v-if="tipoMovimiento == '2'" id="bodyListado">
                <table id="mainTableSG" class="tabla">
                  <thead>
                    <tr>
                      <th>&nbsp;&nbsp;Sel</th>
              ...
              <div v-if="tipoMovimiento === '3'" id="bodyListadoCobranza">
                <table id="mainTableSG" class="tabla">
                  <thead>
                    <tr>
                      <th>&nbsp;&nbsp;Sel</th>
                  ...
                  <tbody>
                    <!-- <tr v-for="data in aData" :key="data.cod_detalle || data.cod_detalle_ingreso" -->
                    <!-- <tr v-for="data in aData" :key="data.id_solicitud" -->
                    <tr
                      v-for="(data, index) in aData"
                      :key="index"
                      style="height: 50px"
                    >
                      ...
                      <td>{{ data.totalusd }}</td>
                      <td>{{ data.detalle }}</td>
                      <!-- <td>{{ data.tipo_resp }}</td> -->
                      <!-- <td>
                                                {{ data.tipo_resp === 1 ? 'PERSONAL' : (data.tipo_resp === 2 ?
                                                'PROVEEDOR' : 'COBRANZA') }}
                                          </td> -->
                    </tr>
                  </tbody>
