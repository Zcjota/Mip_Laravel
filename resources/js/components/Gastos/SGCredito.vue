            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h1 style="text-align: center"><b>LISTADO DE GASTO AL CREDITO</b></h1>
                        <br />
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="panel-body table-responsive">
                                ...
                                <div id="bodyListado">
                                    <table id="mainTableSG" class="tabla">
                                        ...
                                        <tbody>
                                            <tr v-for="data in aData" :key="data.cod_sg" style="height:50px" v-on:click="changeRowColor('mainTableSG')">
                                                <td>
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control input-format" v-model="model.fecha_sg"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <div class="form-group">
                                            <label class="lbl-format">Fecha Pago:</label>
                                            <input type="date" class="form-control input-format" v-model="model.fecha_pago"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                ...
                <div class="modal fade" :class="{'mostrar':modalAcount}" role="dialog">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content model-content-format-2">
                            ...
                            <div class="modal-body">
                                <div class="input-group">
                                    <!-- <input type="text" v-model="searchAcount" class="form-control" placeholder="Buscar Cuenta Contable">
                                    <button type="submit" class="btn btn-primary" v-on:click="listAcount(1, searchAcount)">
                                        <i class="fa fa-search"></i> Buscar
                                    </button> -->
...
<script>
    export default {
        ...
        methods: {
            ...
            openPDFtoPrint(data){
                var pagina = "http://mip2024.isitecnologia.com/api/sgCreditoPDF/"+data.cod_sg;
            ...
            validateNewDetail(){
                ...
                //         swal("Alerta de Mensaje", "Seleccione una Cuenta de Banco Destino.", "warning");
                //         return false;
                //     }
                // }
                return true;
            ...
            validateMainForm(){
                ...
                // if(me.model.fecha_pago <= me.fecha('actual')){
                //     swal("Alerta de Mensaje", "No puede Ingresar una Fecha Pasada o Igual a la Fecha Actual.", "warning");
                //     return false;
                // }
                return true;
            },
            listData(page, buscar, fechaInicio, fechaFin, estado, tipoGasto) {
                ...
                var url = "/api/ZSolicitudGasto/Buscar?page="+page+"&buscar="+buscar+"&fechaInicio="+fechaInicio+"&fechaFin="+fechaFin+"&estado="+estado+"&tipo_sg="+tipoSolicitud+"&tipo_gasto="+tipoGasto;
            ...
            changePage(page, buscar, fechaInicio, fechaFin, estado, tipoGasto){
                let me = this;
                me.pagination.current_page = page;
                me.listData(page, buscar, fechaInicio, fechaFin, estado, tipoGasto);
            },
            ...
            saveRegister(){
                ...
                if(!me.validateMainForm())
                    return;
                axios.post('/api/ZSolicitudGasto',{data:me.model,detalle:me.model.detail}).then(function (reponse){ 
                    if(reponse.data.status == "success"){
                        me.closeWindow();
                        me.cleanForm();
                        swal("Solicitud de Gasto al Credito", "Registrado Correctamente.", "success");
                        me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado,me.tipoGasto);
                    } else {
            ...
            updateRegister(){
                ...
                if(!me.validateMainForm())
                    return;
                axios.put('/api/ZSolicitudGasto',{data:me.model, detalle:me.model.detail}).then(function (reponse){ 
                    if(reponse.data.status == "success"){
                        me.closeWindow();
                        me.cleanForm();
                        swal("Solicitud de Gasto al Credito", "Registro Actualizado Correctamente.", "success");
                        me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado,me.tipoGasto);
                    } else {
                        swal("Solicitud de Gasto al Credito", reponse.data.message, reponse.data.status);
                    }
            ...
            openWindow(action, data = []){
                ...
                switch(action) {
                    case "registrar": { 
                        me.modal = 1;
                        me.modalTitle='Nueva Solicitud de Gasto al Credito';
                        me.modalAction=1;
                        break;
                    };
                    case "actualizar": {
                        me.modal = 1;
                        me.modalTitle='Actualizar Registro Solicitud de Gasto al Credito';
                        me.modalAction = 2;
