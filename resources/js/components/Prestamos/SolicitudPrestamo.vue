            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h1 style="text-align: center"><b>LISTADO DE PRESTAMOS</b></h1>
                        <br />
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input v-model="fechaInicio" class="form-control" type="date" style="width:80px;" v-on:click="listData(1, searchData, fechaInicio, fechaFin, tipoEstado)"/>
                                    <input v-model="fechaFin" class="form-control" type="date" style="width:80px;" v-on:click="listData(1, searchData, fechaInicio, fechaFin, tipoEstado)"/>
                                    <input type="text" v-model="searchData" class="form-control" placeholder="Buscar">
                                    <button class="btn btn-icon square btn-primary" v-on:click="listData(1, searchData, fechaInicio, fechaFin, tipoEstado)">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" disabled="disabled" class="form-control" v-model="model.proveedor"/>
                                                <button type="button" class="btn btn-icon square btn-primary" title="Buscar Proveedor" v-on:click="openSearchProvider">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control input-format" v-model="model.interes_porcentaje"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="lbl-format">Dias:</label>
                                            <input type="number" class="form-control input-format" v-model="model.dias"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="modal-body">
                                <div class="panel-body table-responsive">
                                    <div class="input-group">
                                        ...
                                        <button type="submit" class="btn btn-primary" v-on:click="listDataProvider(1, searchProvider)">
                    ...
                    <div class="modal-dialog modal-danger" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-warning" v-on:click="unregister(model.cod_sp)">
    ...
    export default {
        ...
        methods: {
            ...
            initialize() {
                ...
                me.fechaFin = fecha;
                me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado);
            ...
            listData(page, buscar, fechaInicio, fechaFin, estado) {
                let me =this;
                me.aDataAux = [];
                var url = "/api/prestamos?page="+page+"&buscar="+buscar+"&fechaInicio="+fechaInicio+"&fechaFin="+fechaFin+"&estado="+estado;
            ...
            changePage(page, buscar){
                ...
                me.listData(page, buscar, me.fechaInicio, me.fechaFin, me.tipoEstado);
            },
            ...
            saveRegister(){
                ...
                if(!me.validateMainForm())
                    return;
                axios.post('/api/prestamos/registrar',{data: me.model}).then(function (reponse){
                    if(reponse.data.status == "success"){
                        me.closeWindow();
                        me.cleanForm();
                        swal("Ingreso por Prestamos", "Registrado Correctamente.", "success");
                        me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado);
                    } else {
                        swal("Ingreso por Prestamos", reponse.data.message, reponse.data.status);
                    }
                }).catch(function(error){
                    swal("Ingreso por Prestamos", error.response.data.message, error.response.data.status);
                });
            },
            getDataByID(id){
                let me =this;
            ...
            updateRegister(){
                ...
                if(!me.validateMainForm())
                    return;
                axios.put('/api/prestamos/actualizar',{data:me.model,}).then(function (reponse){
                    if(reponse.data.status == "success"){
                        me.closeWindow();
                        me.cleanForm();
                        swal("Ingreso por Prestamos", "Registro Actualizado Correctamente.", "success");
                        me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado);
                    } else {
                        swal("Ingreso por Prestamos", reponse.data.message, reponse.data.status);
                    }
            ...
            unregister(id){
                let me = this;
                axios.put('/api/prestamos/anular',{
                    cod_sp: id
                }).then(function (reponse){
                    if(reponse.data.status == "success"){
                        me.closeWindow();
                        me.cleanForm();
                        swal("Ingreso por Prestamos", "Registro Anulado Correctamente", "success");
                        me.listData(1, me.searchData, me.fechaInicio, me.fechaFin, me.tipoEstado);
                    } else {
                        swal("Ingreso por Prestamos", reponse.data.message, reponse.data.status);
                    }
            ...
            openWindow(action, data = []){
                ...
                switch(action) {
                    case "registrar": {
                        me.modal = 1;
                        me.modalTitle='Nuevo Registro Ingreso por Prestamos';
                        me.modalAction=1;
                        break;
                    };
                    case "actualizar": {
                        me.modal = 1;
                        me.modalTitle='Actualizar Registro Ingreso por Prestamos';
                        me.modalAction = 2;
            ...
            selectSearchProvider(provider){
                let me=this;
                me.model.cod_pp = provider.id;
                me.model.proveedor = provider.nombre_completo;
