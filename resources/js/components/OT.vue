            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">         
                        ...
                        <button type="button" @click="verificarEstado('reprogramar')" class="btn btn-primary">
                            <i class="icon-plus"></i>&nbsp;Reprogramar
                        </button>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                    <input type="text" v-model="buscar" @keyup="listadoOt(1,buscar)" class="form-control" placeholder="Texto a buscar">
                ...
                <div class="modal-dialog modal-success" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==2"  class="btn btn-success colorVerde" @click="btnReprogramar()">
            ...
            verificarEstado(estado){
                if(this.idOT>0)
                {
                    switch(estado)
                    {
                        case "suspender":
                        { 
                            this.abrirModal('suspender');break;
                        }
                        case "reprogramar":
                        { 
                            this.abrirModal('reprogramar');break;
                        }
                    } 
                }
                else
