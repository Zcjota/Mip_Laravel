<template>
    <main class="main">
      <div class="container-fluid">
        <b-card>
          <b-card-header>
            <BCardTitle> Anular Recibo </BCardTitle>
            <b-row>
              <b-col md="9">
                <div class="input-group">
                  ...
                  <input
                    ...
                    v-model="busqueda"
                    class="form-control"
                    v-on:input="istadoRecibosAnular()"
                    placeholder="Buscar"
                  />
                  <button
                    class="btn btn-icon square btn-primary"
                    v-on:click="istadoRecibosAnular()"
                  >
  ...
  <script>
  import {
    BFormDatepicker,BRow,BModal,VBModal,BAvatar,BCardTitle,BCardBody,BCardHeader,
    BCard,BDropdown,BDropdownItem,BButton,BFormSelect,BCol,BFormGroup,BFormInput,
    BFormCheckbox,BForm,BFormText,BFormDatalist, BBadge, BTable, BMedia, BFormTextarea,
    BInputGroupAppend,BInputGroup,BOverlay, BSpinner, BFormValidFeedback, BFormInvalidFeedback,
  ...
  export default {
    ...
    methods: {
      ...
      istadoRecibosAnular() {
        ...
        me.items = [];
        me.isBusy = true;
        var url = "/api/listadoRecibosAnular";
        me.loaded = false;
        var lista = [];
