...
//CUENTA
// Route::get('/Mip/ProveedorPersonal/ListarCuenta','ProveedorPersonalController@listCuenta');
...
Route::get('/api/Cuenta/Buscar','Comunes\Paginate\CuentaController@Buscar');//OBSEVACIONES
...
Route::get('/api/ZSolicitudGasto/TraerProveedorCC','Gastos\Z_Solicitud_GastoController@TraerProveedorCC');
Route::get('/api/ZSolicitudGasto/ProveedorCuentaContable','Gastos\Z_Solicitud_GastoController@ProveedorCuentaContable');
...
Route::get('/api/ZBancoCuentaDestiny/ListarCbx2','Banco\Z_Banco_CuentaController@ListarDestino');
...
Route::get('/api/reporte/listDataBusqueda','Reports\ReportsController@listDataBusqueda');
